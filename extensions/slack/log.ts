// Structured console logging for the Slack extension: timestamps, context labels, chalk colors.
...
// Usage summary (returns formatted string for posting to Slack)
...
export function logStartup(workingDir: string, sandbox: string): void {
	console.log("Starting Slack extension...");
	console.log(`  Working directory: ${workingDir}`);
	console.log(`  Sandbox: ${sandbox}`);
}

export function logConnected(): void {
	console.log("⚡️ Slack extension connected and listening!");
	console.log("");
}

export function logDisconnected(): void {
	console.log("Slack extension disconnected.");
}
