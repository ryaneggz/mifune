# Source: https://www.linkedin.com/posts/alindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep

## Extracted metadata
- **canonical**: https://www.linkedin.com/posts/alindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep
- **description**: I wrote about turbovec when TurboQuant landed as a Rust vector index. Now it picked up 1.5k stars in the last 24 hours. The reason is practical: 10M-document RAG drops from 31GB to 4GB, with no codebook training and no rebuilds when documents are inserted. Compression is becoming an architecture lever for local retrieval. 6.2k stars. 
#VectorSearch #RAG #Quantization #AIInfra
- **twitter:description**: I wrote about turbovec when TurboQuant landed as a Rust vector index. Now it picked up 1.5k stars in the last 24 hours. The reason is practical: 10M-document RAG drops from 31GB to 4GB, with no codebook training and no rebuilds when documents are inserted. Compression is becoming an architecture lever for local retrieval. 6.2k stars. 
#VectorSearch #RAG #Quantization #AIInfra
- **og:title**: #vectorsearch #rag #quantization #aiinfra | André Lindenberg
- **og:description**: I wrote about turbovec when TurboQuant landed as a Rust vector index. Now it picked up 1.5k stars in the last 24 hours. The reason is practical: 10M-document RAG drops from 31GB to 4GB, with no codebook training and no rebuilds when documents are inserted. Compression is becoming an architecture lever for local retrieval. 6.2k stars. 
#VectorSearch #RAG #Quantization #AIInfra
- **og:url**: https://www.linkedin.com/posts/alindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep
...
<!---->        <meta id="config" data-app-version="1.2.1946" data-call-tree-id="AAZTrTopmYafgHsaEgtImg==" data-multiproduct-name="feedcontent-guest-frontend" data-service-name="feedcontent-guest-frontend" data-browser-id="86084997-a05b-4128-898d-ceb01f022b13" data-is-bot="false" data-enable-page-view-heartbeat-tracking data-page-instance="urn:li:page:d_public_post;u6rS5YZ1QbmUNPE7kWMqwg==" data-disable-jsbeacon-pagekey-suffix="false" data-member-id="0" data-should-use-full-url-in-pve-path="true" data-dna-member-lix-treatment="enabled" data-human-member-lix-treatment="enabled" data-dfp-member-lix-treatment="control" data-sync-apfc-headers-lix-treatment="control" data-sync-apfc-cb-lix-treatment="control" data-recaptcha-v3-integration-lix-value="control" data-network-interceptor-lix-value="control" data-is-epd-audit-event-enabled="false" data-is-feed-sponsored-tracking-kill-switch-enabled="false" data-sequence-auto-redirect-before-request-enabled="true">

        <link rel="canonical" href="https://www.linkedin.com/posts/alindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep">
<!----><!---->
<!---->
<!---->
          <meta property="al:android:url" content="https://www.linkedin.com/posts/alindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep">
          <meta property="al:android:package" content="com.linkedin.android">
          <meta property="al:android:app_name" content="LinkedIn">
          <meta property="al:ios:url" content="https://www.linkedin.com/posts/alindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep">
...
<!---->
  ...
  <meta name="description" content="I wrote about turbovec when TurboQuant landed as a Rust vector index. Now it picked up 1.5k stars in the last 24 hours. The reason is practical: 10M-document RAG drops from 31GB to 4GB, with no codebook training and no rebuilds when documents are inserted. Compression is becoming an architecture lever for local retrieval. 6.2k stars. 
#VectorSearch #RAG #Quantization #AIInfra">
  <meta name="twitter:description" content="I wrote about turbovec when TurboQuant landed as a Rust vector index. Now it picked up 1.5k stars in the last 24 hours. The reason is practical: 10M-document RAG drops from 31GB to 4GB, with no codebook training and no rebuilds when documents are inserted. Compression is becoming an architecture lever for local retrieval. 6.2k stars. 
#VectorSearch #RAG #Quantization #AIInfra">
  <meta property="og:description" content="I wrote about turbovec when TurboQuant landed as a Rust vector index. Now it picked up 1.5k stars in the last 24 hours. The reason is practical: 10M-document RAG drops from 31GB to 4GB, with no codebook training and no rebuilds when documents are inserted. Compression is becoming an architecture lever for local retrieval. 6.2k stars. 
#VectorSearch #RAG #Quantization #AIInfra">


    <meta property="og:title" content="#vectorsearch #rag #quantization #aiinfra | André Lindenberg">
    <meta name="twitter:title" content="#vectorsearch #rag #quantization #aiinfra | André Lindenberg">
    <title>#vectorsearch #rag #quantization #aiinfra | André Lindenberg</title>

      <meta name="twitter:card" content="summary_large_image">

    <meta property="lnkd:url" content="https://www.linkedin.com/feed/update/urn:li:activity:7469390177417818112">
    <meta property="og:type" content="article">
    <meta property="og:url" content="https://www.linkedin.com/posts/alindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep">
    <meta property="og:site_name" content="LinkedIn">
      <meta property="og:locale" content="en_US">
    <meta property="og:image" content="https://media.licdn.com/dms/image/v2/D4D22AQERwQBnQHoYow/feedshare-shrink_1280/B4DZ6iaySeIEAQ-/0/1780841391483?e=2147483647&amp;v=beta&amp;t=_1EwB31QIUcJSYJ6U-W17QhQ23mEdbjl3XjyChcUEPE">
    <meta name="twitter:image" content="https://media.licdn.com/dms/image/v2/D4D22AQERwQBnQHoYow/feedshare-shrink_1280/B4DZ6iaySeIEAQ-/0/1780841391483?e=2147483647&amp;v=beta&amp;t=_1EwB31QIUcJSYJ6U-W17QhQ23mEdbjl3XjyChcUEPE">
    <meta name="twitter:site" content="@linkedin">
    <meta property="twitter:url" content="https://www.linkedin.com/posts/alindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep">
<!---->      <meta name="clientSideIngraphs" content="1" data-gauge-metric-endpoint="/feedcontent-guest/api/ingraphs/gauge" data-counter-metric-endpoint="/feedcontent-guest/api/ingraphs/counter">
      ...
      <script type="application/ld+json">
        {"@context":"http://schema.org","@type":"SocialMediaPosting","@id":"https://www.linkedin.com/posts/alindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep","datePublished":"2026-06-07T14:09:52.838Z","headline":"I wrote about turbovec when TurboQuant landed as a Rust vector index.","comment":[{"@type":"Comment","datePublished":"2026-06-07T14:10:32.284Z","text":"TurboQuant landed as turbovec https://www.linkedin.com/feed/update/urn:li:activity:7460996015790415872","author":{"@type":"Person","name":"André Lindenberg"},"interactionStatistic":{"@type":"InteractionCounter","interactionType":"http://schema.org/LikeAction","userInteractionCount":1}},{"@type":"Comment","datePublished":"2026-06-07T14:11:35.631Z","text":"A vector index built on TurboQuant, written in Rust with Python bindings https://github.com/RyanCodrai/turbovec","author":{"@type":"Person","name":"André Lindenberg"},"interactionStatistic":{"@type":"InteractionCounter","interactionType":"http://schema.org/LikeAction","userInteractionCount":1}},{"@type":"Comment","datePublished":"2026-06-07T14:11:11.154Z","text":"The Substrate Shrinks: When 31GB of RAG Becomes 4GB on a Laptop https://www.linkedin.com/pulse/substrate-shrinks-when-31gb-rag-becomes-4gb-laptop-andré-lindenberg-p2ngf","author":{"@type":"Person","name":"André Lindenberg"},"interactionStatistic":{"@type":"InteractionCounter","interactionType":"http://schema.org/LikeAction","userInteractionCount":1}}],"commentCount":4,"image":{"url":"https://media.licdn.com/dms/image/v2/D4D22AQERwQBnQHoYow/feedshare-shrink_1280/B4DZ6iaySeIEAQ-/0/1780841391483?e=2147483647&v=beta&t=_1EwB31QIUcJSYJ6U-W17QhQ23mEdbjl3XjyChcUEPE","@type":"ImageObject"},"articleBody":"I wrote about turbovec when TurboQuant landed as a Rust vector index. Now it picked up 1.5k stars in the last 24 hours. The reason is practical: 10M-document RAG drops from 31GB to 4GB, with no codebook training and no rebuilds when documents are inserted. Compression is becoming an architecture lever for local retrieval. 6.2k stars. \n#VectorSearch #RAG #Quantization #AIInfra","author":{"name":"André Lindenberg","image":{"url":"https://media.licdn.com/dms/image/v2/D4E03AQHcqetz55YQHQ/profile-displayphoto-scale_200_200/B4EZk6MRxjKwAY-/0/1757617924221?e=2147483647&v=beta&t=_qETLwTR-NfuoHdV4uK4V_mzeXQNE6SRHgzt1sbnZF0","@type":"ImageObject"},"url":"https://de.linkedin.com/in/alindnbrg","@type":"Person","interactionStatistic":{"@type":"InteractionCounter","interactionType":"http://schema.org/FollowAction","userInteractionCount":54555}},"interactionStatistic":[{"@type":"InteractionCounter","interactionType":"http://schema.org/LikeAction","userInteractionCount":93},{"@type":"InteractionCounter","interactionType":"https://schema.org/CommentAction","userInteractionCount":4}],"hasPart":{"@type":"WebPageElement","isAccessibleForFree":false,"cssSelector":".details"}}
      </script>
...
<!----><!----><!---->
    ...
    <form class="google-auth" action="https://www.linkedin.com/uas/login-submit" method="post">
      <input name="loginCsrfParam" value="86084997-a05b-4128-898d-ceb01f022b13" type="hidden">
        <input name="session_redirect" value="https://www.linkedin.com/posts/alindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep" type="hidden">
...
<!---->
    ...
    <a href="https://www.linkedin.com/games?trk=public_post_guest_nav_menu_games" data-tracking-control-name="public_post_guest_nav_menu_games" data-tracking-will-navigate class="top-nav-link flex justify-center items-center min-h-[52px] hover:text-color-text visited:hover:text-color-text hover:no-underline
      ...
      <a class="nav__button-secondary btn-secondary-emphasis ml-3 btn-md" href="https://www.linkedin.com/login?session_redirect=https%3A%2F%2Fwww%2Elinkedin%2Ecom%2Fposts%2Falindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep&amp;fromSignIn=true&amp;trk=public_post_nav-header-signin" data-tracking-control-name="public_post_nav-header-signin" data-tracking-will-navigate data-tracking-client-ingraph>
          Sign in
      </a>
    ...
    <a class="nav__button-tertiary btn-primary btn-md" href="https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww%2Elinkedin%2Ecom%2Fposts%2Falindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep&amp;trk=public_post_nav-header-join" data-tracking-control-name="public_post_nav-header-join" data-test-live-nav-primary-cta data-tracking-will-navigate data-tracking-client-ingraph>
      Join now
<!---->    </a>
...
<!---->
    ...
    <article class="relative px-2 pb-0 bg-color-background-container
        ...
        pt-1.5 main-feed-activity-card
           ...
           main-feed-activity-card-with-comments" data-activity-urn="urn:li:activity:7469390177417818112" data-featured-activity-urn="urn:li:activity:7469390177417818112" data-attributed-urn="urn:li:share:7469390176356753408">
<!---->
...
<!---->    </div>
    ...
    <a href="/uas/login?session_redirect=https%3A%2F%2Fwww.linkedin.com%2Fposts%2Falindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep&amp;trk=public_post_ellipsis-menu-semaphore-sign-in-redirect&amp;guestReportContentType=POST&amp;_f=guest-reporting" data-tracking-control-name="public_post_ellipsis-menu-semaphore-sign-in-redirect" data-tracking-will-navigate data-item-type="semaphore" data-semaphore-content-type="POST" data-semaphore-content-urn="urn:li:activity:7469390177417818112" data-semaphore-tracking-prefix="public_post_ellipsis-menu-semaphore" data-is-logged-in="false" data-modal="semaphore__toggle" class="semaphore__toggle visited:text-color-text-secondary ellipsis-menu__semaphore ellipsis-menu__item-button flex items-center w-full p-1 cursor-pointer font-sans text-sm font-bold link-styled focus:link-styled link:no-underline active:bg-color-background-container-tint focus:bg-color-background-container-tint hover:bg-color-background-container-tint outline-offset-[-2px]" role="menuitem">
<!---->        
...
<!---->    </div>
  ...
  <div class="attributed-text-segment-list__container relative mt-1 mb-1.5 babybear:mt-0 babybear:mb-0.5">
    <p class="attributed-text-segment-list__content text-color-text !text-sm whitespace-pre-wrap break-words
        " dir="ltr" data-test-id="main-feed-activity-card__commentary">I wrote about turbovec when TurboQuant landed as a Rust vector index. Now it picked up 1.5k stars in the last 24 hours. The reason is practical: 10M-document RAG drops from 31GB to 4GB, with no codebook training and no rebuilds when documents are inserted. Compression is becoming an architecture lever for local retrieval. 6.2k stars. 
<a class="link" href="https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww.linkedin.com%2Ffeed%2Fhashtag%2Fvectorsearch&amp;trk=public_post-text" target="_self" data-tracking-control-name="public_post-text" data-tracking-will-navigate>#VectorSearch</a> <a class="link" href="https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww.linkedin.com%2Ffeed%2Fhashtag%2Frag&amp;trk=public_post-text" target="_self" data-tracking-control-name="public_post-text" data-tracking-will-navigate>#RAG</a> <a class="link" href="https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww.linkedin.com%2Ffeed%2Fhashtag%2Fquantization&amp;trk=public_post-text" target="_self" data-tracking-control-name="public_post-text" data-tracking-will-navigate>#Quantization</a> <a class="link" href="https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww.linkedin.com%2Ffeed%2Fhashtag%2Faiinfra&amp;trk=public_post-text" target="_self" data-tracking-control-name="public_post-text" data-tracking-will-navigate>#AIInfra</a></p>
<!---->  </div>
          ...
          " data-test-id="feed-images-content">
              <li class="bg-color-background-container-tint text-[0px]
                  ...
                  <img class="lazy-load w-full object-cover object-center
                      ...
                      " data-delayed-url="https://media.licdn.com/dms/image/v2/D4D22AQERwQBnQHoYow/feedshare-shrink_1280/B4DZ6iaySeIEAQ-/0/1780841391483?e=2147483647&amp;v=beta&amp;t=_1EwB31QIUcJSYJ6U-W17QhQ23mEdbjl3XjyChcUEPE" data-ghost-url="https://static.licdn.com/aero-v1/sc/h/921ynb2z53z33mhm3061qvjag" alt="No alternative text description for this image">
<!----><!---->              </li>
      </ul>
<!---->  
    ...
    <code id="i18n_reactions_plural" style="display: none"><!--"%numReactions% Reactions"--></code>
      ...
      <a href="https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww%2Elinkedin%2Ecom%2Fposts%2Falindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep&amp;trk=public_post_social-actions-reactions" target="_self" data-tracking-control-name="public_post_social-actions-reactions" data-tracking-will-navigate class="flex items-center font-normal text-color-text-low-emphasis !no-underline visited:text-color-text-low-emphasis  my-1" aria-label="93 Reactions" data-separate-ctas="false" data-test-id="social-actions__reactions" data-id="social-actions__reactions" data-num-reactions="93" data-singular="%numReactions%" data-plural="%numReactions%" tabindex="0">
...
<!---->      </div>
  ...
  <a class="social-action-bar__button " href="https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww%2Elinkedin%2Ecom%2Fposts%2Falindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep&amp;trk=public_post_like-cta" data-tracking-control-name="public_post_like-cta" data-tracking-will-navigate>
...
<!---->              
    ...
    <a href="/uas/login?session_redirect=https%3A%2F%2Fwww.linkedin.com%2Fposts%2Falindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep&amp;trk=public_post_comment_ellipsis-menu-semaphore-sign-in-redirect&amp;guestReportContentType=COMMENT&amp;_f=guest-reporting" data-tracking-control-name="public_post_comment_ellipsis-menu-semaphore-sign-in-redirect" data-tracking-will-navigate data-item-type="semaphore" data-semaphore-content-type="COMMENT" data-semaphore-content-urn="urn:li:comment:(urn:li:activity:7469390177417818112,7469390342790807552)" data-semaphore-tracking-prefix="public_post_comment_ellipsis-menu-semaphore" data-is-logged-in="false" data-modal="semaphore__toggle" class="semaphore__toggle visited:text-color-text-secondary ellipsis-menu__semaphore ellipsis-menu__item-button flex items-center w-full p-1 cursor-pointer font-sans text-sm font-bold link-styled focus:link-styled link:no-underline active:bg-color-background-container-tint focus:bg-color-background-container-tint hover:bg-color-background-container-tint outline-offset-[-2px]" role="menuitem">
<!---->        
                      <icon class="ellipsis-menu__item-icon text-color-text h-[24px] w-[24px] mr-1" data-delayed-url="https://static.licdn.com/aero-v1/sc/h/iq0x9q37wj214o129ai1yjut">
                      </icon>
                      Report this comment
...
<!---->    </div>
  ...
  <div class="attributed-text-segment-list__container relative mt-1 mb-1.5 babybear:mt-0 babybear:mb-0.5">
    <p class="attributed-text-segment-list__content text-color-text !text-sm whitespace-pre-wrap break-words
         comment__text babybear:mt-0.5" dir="ltr">TurboQuant landed as turbovec <a class="link" href="https://www.linkedin.com/feed/update/urn:li:activity:7460996015790415872?trk=public_post_comment-text" target="_self" rel="nofollow" data-tracking-control-name="public_post_comment-text" data-tracking-will-navigate>https://www.linkedin.com/feed/update/urn:li:activity:7460996015790415872</a></p>
<!---->  </div>
...
<!---->          </div>
        ...
        <div class="comment__actions flex flex-row flex-wrap items-center ml-2" aria-label="Comment Controls">
              ...
              <a href="https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww%2Elinkedin%2Ecom%2Fposts%2Falindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep&amp;trk=public_post_comment_like" class="comment__action inline-block font-sans text-xs text-color-text-low-emphasis cursor-pointer" data-tracking-control-name="public_post_comment_like" data-tracking-will-navigate>
  ...
  <div class="flex flex-row items-center ">
    ...
    <span class="action-btn__button-text inline-block align-baseline">
      Like
                ...
                <a href="https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww%2Elinkedin%2Ecom%2Fposts%2Falindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep&amp;trk=public_post_comment_reply" class="comment__action inline-block font-sans text-xs text-color-text-low-emphasis cursor-pointer comment__reply" data-feed-action="replyToComment" data-feed-control="reply" data-feed-action-category="EXPAND" data-feed-action-type="expandReplyBox" data-tracking-control-name="public_post_comment_reply" data-tracking-will-navigate>
...
<!---->              
    ...
    <a href="/uas/login?session_redirect=https%3A%2F%2Fwww.linkedin.com%2Fposts%2Falindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep&amp;trk=public_post_comment_ellipsis-menu-semaphore-sign-in-redirect&amp;guestReportContentType=COMMENT&amp;_f=guest-reporting" data-tracking-control-name="public_post_comment_ellipsis-menu-semaphore-sign-in-redirect" data-tracking-will-navigate data-item-type="semaphore" data-semaphore-content-type="COMMENT" data-semaphore-content-urn="urn:li:comment:(urn:li:activity:7469390177417818112,7469390608491745281)" data-semaphore-tracking-prefix="public_post_comment_ellipsis-menu-semaphore" data-is-logged-in="false" data-modal="semaphore__toggle" class="semaphore__toggle visited:text-color-text-secondary ellipsis-menu__semaphore ellipsis-menu__item-button flex items-center w-full p-1 cursor-pointer font-sans text-sm font-bold link-styled focus:link-styled link:no-underline active:bg-color-background-container-tint focus:bg-color-background-container-tint hover:bg-color-background-container-tint outline-offset-[-2px]" role="menuitem">
<!---->        
                      <icon class="ellipsis-menu__item-icon text-color-text h-[24px] w-[24px] mr-1" data-delayed-url="https://static.licdn.com/aero-v1/sc/h/iq0x9q37wj214o129ai1yjut">
                      </icon>
                      Report this comment
...
<!---->    </div>
  ...
  <div class="attributed-text-segment-list__container relative mt-1 mb-1.5 babybear:mt-0 babybear:mb-0.5">
    <p class="attributed-text-segment-list__content text-color-text !text-sm whitespace-pre-wrap break-words
         comment__text babybear:mt-0.5" dir="ltr">A vector index built on TurboQuant, written in Rust with Python bindings <a class="link" href="https://github.com/RyanCodrai/turbovec?trk=public_post_comment-text" target="_self" rel="nofollow" data-tracking-control-name="public_post_comment-text" data-tracking-will-navigate>https://github.com/RyanCodrai/turbovec</a></p>
<!---->  </div>
...
<!---->              
    ...
    <a href="/uas/login?session_redirect=https%3A%2F%2Fwww.linkedin.com%2Fposts%2Falindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep&amp;trk=public_post_comment_ellipsis-menu-semaphore-sign-in-redirect&amp;guestReportContentType=COMMENT&amp;_f=guest-reporting" data-tracking-control-name="public_post_comment_ellipsis-menu-semaphore-sign-in-redirect" data-tracking-will-navigate data-item-type="semaphore" data-semaphore-content-type="COMMENT" data-semaphore-content-urn="urn:li:comment:(urn:li:activity:7469390177417818112,7469390505823354880)" data-semaphore-tracking-prefix="public_post_comment_ellipsis-menu-semaphore" data-is-logged-in="false" data-modal="semaphore__toggle" class="semaphore__toggle visited:text-color-text-secondary ellipsis-menu__semaphore ellipsis-menu__item-button flex items-center w-full p-1 cursor-pointer font-sans text-sm font-bold link-styled focus:link-styled link:no-underline active:bg-color-background-container-tint focus:bg-color-background-container-tint hover:bg-color-background-container-tint outline-offset-[-2px]" role="menuitem">
<!---->        
                      <icon class="ellipsis-menu__item-icon text-color-text h-[24px] w-[24px] mr-1" data-delayed-url="https://static.licdn.com/aero-v1/sc/h/iq0x9q37wj214o129ai1yjut">
                      </icon>
                      Report this comment
...
<!---->    </div>
  ...
  <div class="attributed-text-segment-list__container relative mt-1 mb-1.5 babybear:mt-0 babybear:mb-0.5">
    <p class="attributed-text-segment-list__content text-color-text !text-sm whitespace-pre-wrap break-words
         comment__text babybear:mt-0.5" dir="ltr">The Substrate Shrinks: When 31GB of RAG Becomes 4GB on a Laptop <a class="link" href="https://www.linkedin.com/pulse/substrate-shrinks-when-31gb-rag-becomes-4gb-laptop-andré-lindenberg-p2ngf?trk=public_post_comment-text" target="_self" rel="nofollow" data-tracking-control-name="public_post_comment-text" data-tracking-will-navigate>https://www.linkedin.com/pulse/substrate-shrinks-when-31gb-rag-becomes-4gb-laptop-andré-lindenberg-p2ngf</a></p>
<!---->  </div>
  ...
  <div class="flex flex-row items-center ">
    ...
    <span class="action-btn__button-text inline-block align-baseline">
      Reply
              ...
              <a class="block text-sm text-color-text-low-emphasis font-bold mb-2" href="https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww%2Elinkedin%2Ecom%2Fposts%2Falindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep&amp;trk=public_post_see-more-comments" data-test-id="main-feed-activity-card-with-comments__see-more-comments" data-tracking-control-name="public_post_see-more-comments" data-tracking-will-navigate>
                See more comments
              </a>
    ...
    <p class="feed-cta-banner__text border-t-1 border-color-surface-border border-solid p-3 text-center text-md text-color-text-low-emphasis">
        To view or add a comment, <a href="https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww%2Elinkedin%2Ecom%2Fposts%2Falindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep&trk=public_post_feed-cta-banner-cta" target="" aria-label="To view or add a comment, sign in" data-tracking-control-name="public_post_feed-cta-banner-cta" data-tracking-will-navigate="true" class="feed-cta-banner__link link">sign in</a>
    </p>
...
<!---->    
      ...
      <a href="https://www.linkedin.com/pulse/modernization-loop-needs-score-andr%C3%A9-lindenberg-6fwqf?trk=public_post" target="_self" data-tracking-control-name="public_post" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
...
<!---->
  ...
  <div class="base-aside-card__media flex-shrink-0 mr-0.5 overflow-hidden relative rounded-md
      h-[54px] w-[95px]">
        ...
        <img class="lazy-load base-aside-card__media-element w-[100px] h-full object-cover" data-delayed-url="https://media.licdn.com/dms/image/v2/D4D12AQFLyBdZhKMlyA/article-cover_image-shrink_600_2000/B4DZ6ej01_KwAM-/0/1780776652389?e=2147483647&amp;v=beta&amp;t=joLrnqaSMPPlfQeLF8KKC10CHoMdByxJ-Shwo_AclRU" data-ghost-url="https://static.licdn.com/aero-v1/sc/h/9l8dv1r8a09nem281grvopn9l" alt>
...
<!---->  </div>
        ...
        The IT Modernization Loop Needs a Score
...
<!---->    
      ...
      <a href="https://www.linkedin.com/pulse/map-only-surface-andr%C3%A9-lindenberg-bp87f?trk=public_post" target="_self" data-tracking-control-name="public_post" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] base-aside-card flex my-1.5
...
<!---->
  ...
  <div class="base-aside-card__media flex-shrink-0 mr-0.5 overflow-hidden relative rounded-md
      h-[54px] w-[95px]">
        ...
        <img class="lazy-load base-aside-card__media-element w-[100px] h-full object-cover" data-delayed-url="https://media.licdn.com/dms/image/v2/D4D12AQHoRFWy7imzSg/article-cover_image-shrink_600_2000/B4DZ56mjO2H4AM-/0/1780173386988?e=2147483647&amp;v=beta&amp;t=rVuikHkfnvLZ7aYzHF25T648axC6PSEDm-SvCEGHhJw" data-ghost-url="https://static.licdn.com/aero-v1/sc/h/9l8dv1r8a09nem281grvopn9l" alt>
...
<!---->    </div>
                    ...
                    <p class="contextual-sign-in-modal__join-now m-auto font-sans text-md text-center text-color-text my-2">
                      New to LinkedIn? <a href="https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww%2Elinkedin%2Ecom%2Fposts%2Falindnbrg_vectorsearch-rag-quantization-activity-7469390177417818112-AJep&trk=public_post_contextual-sign-in-modal_join-link" data-tracking-control-name="public_post_contextual-sign-in-modal_join-link" data-tracking-will-navigate="true" class="contextual-sign-in-modal__join-link">Join now</a>
                    </p>
...
<!---->
        <code id="activityUrn" style="display: none"><!--"urn:li:activity:7469390177417818112"--></code>
