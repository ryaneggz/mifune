...
- **Writing outside `.claude/specs/<slug>/`.** No spillover into `.oh/tasks/`, `.oh/memory/<topic>.md`, `.mifune/skills/wiki/corpus/`, or root. Those surfaces have their own skills.
